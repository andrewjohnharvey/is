          ...
          <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {AUDIENCE_OPTIONS.map((audience) => (
                    <AudienceCard
                      ...
                      key={audience.id}
                      onSelect={() =>
                        onUpdateContext({ audience: audience.id })
                      }
                    />
                  ))}
                </div>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div>
                ...
                <p className="mb-4 text-muted-foreground text-sm">
                  Expected renewal increase and budget context
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label
              ...
              <div>
                ...
                <p className="mb-4 text-muted-foreground text-sm">
                  Industry, regional, or national comparison data
                </p>
              ...
              {/* Strategy Ideas Section */}
              <div>
                <h2 className="mb-2 font-semibold text-foreground text-lg">
                  Strategy Ideas
                </h2>
                <p className="mb-4 text-muted-foreground text-sm">
                  Share cost-saving strategies for the AI to consider
                </p>
                <textarea
                  className="min-h-[100px] w-full resize-y rounded-xl border border-border bg-background px-4 py-3 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                  id="strategy-ideas"
                  onChange={(e) =>
              ...
              <div>
                ...
                <p className="mb-4 text-muted-foreground text-sm">
                  Any other information for better insights
                </p>
                <textarea
                  className="min-h-[100px] w-full resize-y rounded-xl border border-border bg-background px-4 py-3 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
  ...
  return (
    <Card
      className={cn(
        ...
        isDisabled ? "cursor-not-allowed opacity-50 hover:border-border" : null
      )}
